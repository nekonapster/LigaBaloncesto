                ...
                <div class="marco2">
                    <div class="tab-content" id="v-pills-tabContent">
                        <div
                            ...
                            <jsp:include page="/submenu/usuarios.jsp" />
                        </div>
                        ...
                        <div
                            ...
                            <br/>
                            <jsp:include page="/submenu/equipos.jsp" />
                            <br/>
                            <jsp:include page="/submenu/jornadas.jsp" />
                            <br/>
                            <jsp:include page="/submenu/partidos.jsp" />
                        </div>
                        <div
                            class="tab-pane fade"
                            id="v-pills-graficas"
                            role="tabpanel"
                            aria-labelledby="v-pills-graficas-tab">
                        ...
                        <div
                            ...
                            >
                            <%@include file="/submenu/configuracion.jsp" %>
                        </div>
                        <div
                            class="tab-pane fade"
                            id="v-pills-cerrar"
